...
export default function ResetPassword() {
    ...
    return (
        <>
            ...
            <div className="w-full border-stroke dark:border-strokedark flex flex-row min-h-screen justify-center items-center" >
                <form onSubmit={setPassword} className="w-full p-4 sm:p-12.5 xl:p-17.5">
